...
static const CGFloat kEMCCountryCellControllerMinCellHeight = 40;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    backView.frame = CGRectMake(0, 0, rootView.frame.size.width, 60);
    backView.backgroundColor = [UIColor whiteColor];
    [rootView addSubview:backView];
    
    UILabel* title = [[UILabel alloc]init];
    title.frame = CGRectMake(backView.frame.size.width/2-100, 18, 200, 40);
    ...
    back.frame = CGRectMake(0, 18, 50, 40);
    [back setTitle:@"<" forState:UIControlStateNormal];
    back.titleLabel.font = [UIFont boldSystemFontOfSize:30];
...
- (void)loadView
{
    ...
    [rootView setBackgroundColor:[UIColor colorWithRed:43.0/255.0 green:53.0/255.0 blue:61.0/255.0 alpha:1.0f]];
    rootView.autoresizesSubviews = YES;
    
    countryTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 60, [rootView frame].size.width, [rootView frame].size.height)];
    ...
    searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 80, [rootView frame].size.width, 0)];
    [searchBar setTranslatesAutoresizingMaskIntoConstraints:NO];
    searchBar.delegate = self;
    [searchBar sizeToFit];
    [[UITextField appearanceWhenContainedIn:[UISearchBar class], nil] setDefaultTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithRed:42/255.0 green:59/255.0 blue:69/255.0 alpha:1]}];
    [[UITextField appearanceWhenContainedIn:[UISearchBar class], nil] setFont:[UIFont fontWithName:@"Ubuntu" size:14]];
    [searchBar setTintColor:[UIColor colorWithRed:43.0/255.0 green:53.0/255.0 blue:61.0/255.0 alpha:1.0f]];
    searchBar.barTintColor = [UIColor colorWithRed:43.0/255.0 green:53.0/255.0 blue:61.0/255.0 alpha:1.0f];
    [searchBar setTintColor:[UIColor whiteColor]];
    searchBar.placeholder=@"Search for Your Country.";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.textColor=[UIColor colorWithRed:43.0/255.0 green:53.0/255.0 blue:61.0/255.0 alpha:1.0f];
    ...
    sepLine.frame=CGRectMake(0, 44, self.view.frame.size.width, 1);
